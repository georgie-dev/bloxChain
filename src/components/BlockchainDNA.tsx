...
const BlockchainDNA = () => {
  ...
  return (
    <div className=' max-w-[80rem] box-content my-0 mx-auto py-0 px-10'>
        <section className=' bg-[#fff2e580]/50 bg-dna text-[#f28b24] rounded-[1.25rem] grid bg-no-repeat min-h-[52.5rem] my-[3.75rem] mx-auto max-w-[80rem]' style={{gridTemplateColumns : '1fr 1fr' , backgroundSize: '31.25rem', backgroundPositionX : ' right', backgroundPositionY: 'bottom 2.5rem'}}>
        <div className=' flex flex-col pl-[8.75rem] justify-start py-[100px]'>
