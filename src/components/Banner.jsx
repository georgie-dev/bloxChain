...
const Banner = () => {
  return (
    <section className=' bg-[#121d33] bg-banner bg-no-repeat text-white py-20 px-0' style={{ backgroundSize: '90rem', backgroundPositionX: '-0.0625rem', backgroundPositionY: 'center' }}>
      <div className=' flex flex-col md:flex-row gap-8 md:gap-0 items-center justify-center box-content max-w-[62.5rem] my-0 mx-auto py-0 px-10'>
        <h2 className=' m-0 md:mr-8 text-center md:text-left text-[2.5rem] font-medium'>Let us take you from zero to crypto</h2>
