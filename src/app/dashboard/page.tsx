                                        ...
                                        <div className=' flex items-center justify-between'>
                                            ...
                                            <div className=' flex flex-col items-end'>
                                                ...
                                                <div className=' mt-[5px] flex flex-row justify-start items-center'>
                                                    <div className=' text-xs whitespace-nowrap font-sans font-medium text-[#98a1b2] block cursor-pointer'>{cryptoData[0]?.btc} BTC</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className=' hover:cursor-pointer'>
                                        <div className=' flex items-center justify-between'>
                                            ...
                                            <div className=' flex flex-col items-end'>
                                                ...
                                                <div className=' mt-[5px] flex flex-row justify-start items-center'>
                                                    <div className=' text-xs whitespace-nowrap font-sans font-medium text-[#98a1b2] block cursor-pointer'>{cryptoData[0]?.eth} ETH</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className=' hover:cursor-pointer'>
                                        <div className=' flex items-center justify-between'>
                                            ...
                                            <div className=' flex flex-col items-end'>
                                                ...
                                                <div className=' mt-[5px] flex flex-row justify-start items-center'>
                                                    <div className=' text-xs whitespace-nowrap font-sans font-medium text-[#98a1b2] block cursor-pointer'>{cryptoData[0]?.sol} SOL</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
